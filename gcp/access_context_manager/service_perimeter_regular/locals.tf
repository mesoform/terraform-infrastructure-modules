locals {
  ...
  vpc_accessible_services = var.vpc_accessible_services == null ? ["RESTRICTED-SERVICES"] : local.enable_vpc_accessible_services == false ? [] :
        var.vpc_accessible_services  vpc_enable_restriction = contains(local.vpc_accessible_services, "ALL-SERVICES" ) ? false : true
